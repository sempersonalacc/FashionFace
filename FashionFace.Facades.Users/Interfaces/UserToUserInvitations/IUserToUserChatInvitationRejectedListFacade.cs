...
public interface IUserToUserChatInvitationRejectedListFacade :
    IQueryFacade
    <
        UserToUserChatInvitationRejectedListArgs,
        ListResult<UserToUserChatInvitationRejectedListItemResult>>;