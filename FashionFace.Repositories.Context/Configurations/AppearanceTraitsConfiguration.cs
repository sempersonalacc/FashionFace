...
public sealed class AppearanceTraitsConfiguration : EntityBaseConfiguration<AppearanceTraits>
{
    public override void Configure(EntityTypeBuilder<AppearanceTraits> builder)
    {
        ...
        builder
            .Property(entity => entity.SexType)
        ...
        builder
            .Property(entity => entity.FaceType)
        ...
        builder
            .Property(entity => entity.HairColorType)
        ...
        builder
            .Property(entity => entity.HairType)
        ...
        builder
            .Property(entity => entity.HairLengthType)
        ...
        builder
            .Property(entity => entity.BodyType)
        ...
        builder
            .Property(entity => entity.SkinToneType)
        ...
        builder
            .Property(entity => entity.EyeShapeType)
        ...
        builder
            .Property(entity => entity.EyeColorType)
        ...
        builder
            .Property(entity => entity.NoseType)
        ...
        builder
            .Property(entity => entity.JawType)
        ...
        builder
            .Property(entity => entity.Height)
            .HasColumnName("Height")
            .HasColumnType("integer")
            .IsRequired();

        builder
            .Property(entity => entity.ShoeSize)
        ...
        builder
            ...
            .WithOne(entity => entity.AppearanceTraits)
            .HasForeignKey<AppearanceTraits>(entity => entity.ProfileId)
