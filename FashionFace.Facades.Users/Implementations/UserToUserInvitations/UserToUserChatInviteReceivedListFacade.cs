...
public sealed class UserToUserChatInvitationReceivedListFacade(
    IGenericReadRepository genericReadRepository
) : IUserToUserChatInvitationReceivedListFacade
{
    public async Task<ListResult<UserToUserChatInvitationReceivedListItemResult>> Execute(
        UserToUserChatInvitationReceivedListArgs args
    )
    {
        ...
        var userToUserChatInvitationList =
            await
                userToUserChatInvitationCollection
                    ...
                    .Select(
                        entity =>
                            new UserToUserChatInvitationReceivedListItemResult(
                                entity.Id,
        ...
        var result =
            new ListResult<UserToUserChatInvitationReceivedListItemResult>(
                totalCount,
