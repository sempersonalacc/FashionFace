...
public sealed class UserToUserChatInvitationRejectedNotificationHandlerBuilder : IUserToUserChatInvitationRejectedNotificationHandlerBuilder
{
    ...
    public AsyncEventHandler<BasicDeliverEventArgs> Build(
        ...
        ) =>
        {
            ...
            var logger =
                serviceProvider.GetRequiredService<ILogger<UserToUserChatInvitationRejectedNotificationHandlerBuilder>>();
            ...
            var outboxBatchStrategy =
                serviceProvider.GetRequiredService<IOutboxBatchStrategy<UserToUserChatInvitationRejectedOutbox>>();
