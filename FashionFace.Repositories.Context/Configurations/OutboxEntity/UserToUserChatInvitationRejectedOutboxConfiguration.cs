...
public sealed class UserToUserChatInvitationRejectedOutboxConfiguration :
    EntityConfigurationBase<UserToUserChatInvitationRejectedOutbox>
{
    public override void Configure(EntityTypeBuilder<UserToUserChatInvitationRejectedOutbox> builder)
    {
        base.Configure(
            builder
        );
