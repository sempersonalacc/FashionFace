...
public sealed class UserToUserChatInvitationAcceptedNotificationHandlerBuilder : IUserToUserChatInvitationAcceptedNotificationHandlerBuilder
{
    ...
    public AsyncEventHandler<BasicDeliverEventArgs> Build(
        ...
        ) =>
        {
            ...
            var logger =
                serviceProvider.GetRequiredService<ILogger<UserToUserChatInvitationAcceptedNotificationHandlerBuilder>>();
            ...
            var outboxBatchStrategy =
                serviceProvider.GetRequiredService<IOutboxBatchStrategy<UserToUserChatInvitationAcceptedOutbox>>();
