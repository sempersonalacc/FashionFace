...
public sealed class UserToUserChatInvitationCreatedNotificationHandlerBuilder : IUserToUserChatInvitationCreatedNotificationHandlerBuilder
{
    ...
    public AsyncEventHandler<BasicDeliverEventArgs> Build(
        ...
        ) =>
        {
            ...
            var logger =
                serviceProvider.GetRequiredService<ILogger<UserToUserChatInvitationCreatedNotificationHandlerBuilder>>();
            ...
            var outboxBatchStrategy =
                serviceProvider.GetRequiredService<IOutboxBatchStrategy<UserToUserChatInvitationCreatedOutbox>>();
