...
builder.Services.AddHostedService<UserToUserChatMessageOutboxPendingWorker>();
builder.Services.AddHostedService<UserToUserChatMessageOutboxClaimedRetryWorker>();
