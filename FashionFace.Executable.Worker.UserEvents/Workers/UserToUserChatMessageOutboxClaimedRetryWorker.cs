...
public sealed class UserToUserChatMessageOutboxClaimedRetryWorker(
    ...
    ILogger<UserToUserChatMessageOutboxClaimedRetryWorker> logger
) : BaseBackgroundWorker<UserToUserChatMessageOutboxClaimedRetryWorker>(
    logger
)
{
